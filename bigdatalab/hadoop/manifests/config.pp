class hadoop::config(
  ...
  $enable_external_hdfs = false,
  $external_master_cluster_dfs = 'DISABLED',
  $dfs_internal_nameservices = 'DISABLED',
  $external_namenode_rpc_port = 'DISABLED',
  $external_master_namenode1 = 'DISABLED',
  $external_master_namenode1_alias = 'DISABLED',
  $external_master_namenode2 = 'DISABLED',
  $external_master_namenode2_alias = 'DISABLED',
) {  
