class roles::dsapimaintainer {
  ...
  include datastore::applications::usagestatswrite
  include datastore::applications::usagestatsread
  ...
  include datastore::applications::productread
  include datastore::applications::productwrite

#  include datastore::applications::bigbrother
